...
- The Dormancy appears only in analysis/feature_engineering. In the pipeline I havn't added it because it doesn't make sense in presence of Recency and Frequency.
